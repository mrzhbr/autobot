...
- Scans issue text before triage, proposed changes before disk writes, and generated diffs before review, commit, and PR creation for common secret-like values, including raw provider tokens.
