...
- Redacts token-like values from CLI, GitHub command, GitHub HTTP, doctor issue-read, abandoned-state, verification-output, PR body, audit, and issue-comment messages.
